    ...
    async function runSearch() {
        ...
        try {
            ...
            if (!hasMorePages && currentPage === 1) {
                ...
                resultStats.innerHTML = `<strong>${data.items.length}</strong> items matched your strict filters (out of ${totalStr} raw eBay listings)`;
            } else {
                resultStats.innerHTML = `Found <strong>${totalStr}</strong> raw eBay listings before your strict filters were applied`;
            }

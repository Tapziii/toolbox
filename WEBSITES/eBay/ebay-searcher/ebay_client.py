...
class EBayClient:
    ...
    def _parse_html(self, html: str, currency: str) -> Tuple[List[Dict[str, Any]], str]:
        ...
        if "verify you are a human" in lower_html or "security measure" in lower_html or "captcha" in lower_html:
            raise Exception("eBay temporarily blocked the request with a CAPTCHA. Please try again later or change your IP.")
